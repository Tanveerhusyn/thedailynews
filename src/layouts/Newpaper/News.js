...
const News = ({
  ...
  const lowerCase = category=="frontPage"?"frontPage":category=="Remaining"?"Remaining":category.toLowerCase();
  console.log(continuePageNum[`${lowerCase}`])
  return (
      ...
      <Grid style={{ width: "100%" }} container spacing={1}>
        ...
        >
          ...
          >
            ...
            <div style={{ width:'474px', height:'100%', position:'relative' }}>
    <p style={{
      textAlign: "justify",
    ...
    <span style={{ fontSize:'10px', fontWeight:'bold' }}>{`Continue on Page ${continuePageNum[`${lowerCase}`][0]}`}</span>
  </div>
              
                <img
                  style={{ width: "240px", height: "190px",margin:'1px 20px', }}
                  src={content[0]?.image}
                  alt="newspaper"
                />
        ...
        >
          ...
          <p
           style={{
            width: "340px", // set a fixed width for the container element
    textAlign: "justify",
    textJustify: "inter-word",
    overflow: "hidden",
    display: "-webkit-box",
          ...
          <Grid item sx={12}>
            <figure style={{ display: "flex" }}>
              ...
              >
                ...
                {content[2] && visibleID === 3 && (
                  ...
                  >
                    ...
                    <AlertDialog top={50} left={60} title={content[2]?.title} category={category}/>
                  </div>
                )}
              </span>
              <span
              ...
              >
                ...
                >
                  {content[3] && <p style={{ textAlign: "start" }}>By: Tanveer Hussain</p> }
...
{content[3] && <span style={{ fontSize:'10px', fontWeight:'bold' }}>{`Continue on Page ${continuePageNum[`${lowerCase}`][0]}`}</span>              }
        ...
        >
          <div>
            ...
            >
              {content[4] && <p style={{ textAlign: "start" }}>By: Tanveer Hussain</p> }
              <hr style={{ width: "80%", borderTop: "1px solid black" }} />
            </div>

            <p className="bottom-articles">{content[4]?.description}</p>
           {content[4] &&  <span style={{ fontSize:'10px', fontWeight:'bold' }}>{`Continue on Page ${continuePageNum[`${lowerCase}`][1]}`}</span>}
        ...
        <Grid style={{ display: "flex"  ,opacity: `${visibleID == 6 ? 0.6 : 1}`,}} order={{ sm: order4 }}>
          ...
          >
           ...
           {content[5] &&  <span style={{ fontSize:'10px', fontWeight:'bold' }}>{`Continue on Page ${continuePageNum[`${lowerCase}`][1]}`}</span>}
          ...
          >
           ...
           {content[6] &&  <span style={{ fontSize:'10px', fontWeight:'bold' }}>{`Continue on Page ${continuePageNum[`${lowerCase}`][1]}`}</span>}
          ...
          >
           ...
           {content[7] &&  <span style={{ fontSize:'10px', fontWeight:'bold' }}>{`Continue on Page ${continuePageNum[`${lowerCase}`][1]}`}</span>}
